...
CREATE TABLE IF NOT EXISTS Room (id INT NOT NULL, coverImageSrc VARCHAR(45) NULL, mapIdentification VARCHAR(45) NULL, PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS NonClickableRoom (id INT NOT NULL, mapIdentification VARCHAR(45) NULL, name VARCHAR(100) NOT NULL, idLanguage INT NOT NULL, PRIMARY KEY (id), FOREIGN KEY (idLanguage) REFERENCES Language (id));
